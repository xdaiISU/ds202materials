...
- `coord_flip`: Flipping x- and y-axis
- `coord_map`: Later, for making maps
...
<span style="color:white"><img src="images/blue.png" width=20> Another approach to fix the domination by CA, TX and NY: Read up on the parameters in `facet_wrap` to find a way to give each panel its own scale. Comment on the difference in the results.</font>
