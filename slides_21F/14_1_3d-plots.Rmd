...
- The design is very similar to `ggplot`, using aethetics mappings and layered specification. 
- `plotly` can do much much more than what I will show! See the [gallery](https://plotly.com/r/) 
...
- The syntax of `plotly` is just a bit different: 
...
<img src="images/green.png" width=20> Highly the time series for Iowa using the `color=` option.</br>
</span>
