...
1. <span style="color:white"> Start from the oldest commit, and browse through the commits. What does each commit do (describe a few)? You only need to have an overall impression what each commit does, and you don't need to read the details of the code. 
 </span>
