...
- Optionally, the binwidth can be set using `geom_histogram(binwidth=...)`
...
## Changing bandwidth in a histogram
...
Side-by-side histogram works well comparing a small number of distributions
...
<span style="color:white"><img src="images/green.png" width=20> Visualize the number of violent crimes in all states and all years using a barchart. Make the height of the bars dependent on the number of reports (use `aes(..., weight=)`). </br>
<img src="images/green.png" width=20> Color bars by `Type`. </font></br>
