...
<!-- <span style="color:white">For this your turn import the "Defensive" sheet from  `cyclonesFootball2020.xlsx` into R and name the data frame `defense`. What does each column stand for? </span> -->
...
<span style="color:white">For this your turn use the `defense` data from the `cyclonesFootball2020.xlsx` </span>
