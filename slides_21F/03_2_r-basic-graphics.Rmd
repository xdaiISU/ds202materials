...
<img class="cover" src="images/blue.jpeg" alt="" width=2000>
<span style="color:white"> Explore the `cities` data, but now focus on the city cloests to your hometown if are from Iowa (or Ames if you are not). Focus on data in 2016. </span>

1. <span style="color:white"><img src="images/green.png" width=20> 
Look at the crime rates of the different crimes in the city you chose.</span>
2. <span style="color:white"><img src="images/blue.png" width=20> 
Compare crime rates in the city you chose with the rest of the cities. </span>
3. <span style="color:white"><img src="images/blue.png" width=20> 
Which crimes were worse in the city you chose, compared to other cities?</span>
3. <span style="color:white"><img src="images/blue.png" width=20> 
Which crimes were better in the city you chose, compared to other cities?</span>
