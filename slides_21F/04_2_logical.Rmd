...
<span style="color:white"><img src="images/black.png" width=20> Get a subset of the data that includes number of murders for the last five years. Find the murder rates, extract all states that have a rate of greater than 90% of the rates across all states, and plot (Hint: `?quantile`).</span>
