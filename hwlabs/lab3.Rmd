...
- Optionally, team up with another student
...
6. Finish this question only if you work with a partner: Explore one more interesting question, and answer the question using the GSS data. 

    *Your exploration will be evaluated according to the  general interest and the depth of the exploration.*
