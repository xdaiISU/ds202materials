...
0. Understanding the dataset: Read the description for the Columns in this Dataset. We will come back here for answering the questions.

2. The complete dataset is too large. Download and import the alcohol sales data for Ames only: 

    a. Go to https://data.iowa.gov/Sales-Distribution/2021-Iowa-Liquor-Sales/cc6f-sgik
