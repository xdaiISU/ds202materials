...
1. Create a folder named `ds202_hw1`, and *either* create an RMarkDown file `hw1_FirstName_LastName.Rmd` under this folder *or* move the provided template into this folder and rename it to ``hw1_FirstName_LastName.Rmd`.
