...
1. Find if each flight number is being used only once in a day. (Hint: You may need the `any()` function).
...
4. Which 5 destination airports have the most severe arrival delay? The severity of delay is defined as the proportion of arriving flights that have no less than 30 minutes arrival delay. Create a data frame containing their airport name, code, and the severity of delay.
