...
2. Create a vector of numbers that runs from 200 to 1. Set the value of the entries to 0 for every 3 entries, starting from the first entry. Storage the results in a variable named `vec200` and print.
...
1. What are the 5 least fuel-efficient models in terms of highway mileage? Storage the data frame (with 5 rows) containing all information of these three cars in a variable named `worst5` and print.
