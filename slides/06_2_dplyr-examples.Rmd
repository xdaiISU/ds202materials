...
<img class="cover" src="https://images.sidearmsports.com/sidearm.sites/isuni.sidearmsports.com/images/logo_top.png" alt="Iowa State" width=100%>
...
- cleaning the 2019 Cyclone football data
- working with `group_by` and `summarize`

## The 2019 Cyclone football data

- [Iowa State University Athelete](https://cyclones.com/index.aspx) hosts some statistics for the Cyclone football team for the last season [here](https://cyclones.com/cumestats.aspx?path=football). 
