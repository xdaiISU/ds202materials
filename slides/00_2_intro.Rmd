...
* __Extensible__: Almost 17000 user contributed add-on packages currently on CRAN! Bioconductor has almost 2000 packages. Many researchers provide R packages through github.
* __Flexible__
...
- study recorded lecture videos by class time on Monday;
- finish individual quiz by class time on Monday; 
- attempt an identical group quiz in class on Monday;
- during Monday's meeting, participate in demonstrations, group case studies, and lab activities;
- work on weekly assignment in Wednesday's meeting;
- hand in your assignment by the same Friday.

## Getting Help

There's lots of ways to get help in case you are stuck:

1. Ask the instructor and the TA during Wednesday's class
2. Ask a groupmate
3. Post on Piazza
...
[Piazza](https://piazza.com/iastate/spring2021/ds202) will be used as the class' online forum, which is assessible within Canvas. 
...
## Introduce yourself to the groupmates (6 minutes)

Next up, break into groups and introduce yourselves. Please include the following points:
